...
release:
	...
	@echo Replace version in lingo/__init__.py
	@sed -i.bak "s/__version__ = \"$(CURRENT_VERSION)\"/__version__ = \"$(NEW_VERSION)\"/" lingo/__init__.py

	@echo Remove backup files
	@rm pyproject.toml.bak lingo/__init__.py.bak
